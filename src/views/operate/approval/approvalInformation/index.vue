      ...
      <el-table-column label="修改前" align="center">
        ...
        <template slot-scope="scope">
          ...
          <el-popover
            ...
            v-if="scope.row.type == 4"
          >
             <video :src="scope.row.afterValue" width="320" height="200" controls preload type="video/mp4"></video>
            <div slot="reference" class="name-wrapper">
              <video width="60" height="60" controls>
                <source :src="scope.row.afterValue" type="video/mp4" />
              </video>
...
export default {
  ...
  methods: {
    ...
    handleCheck(row) {
      console.log(row);
      location.href = `${window.location.origin}/#/operate/approval/auditDetail`;
    ...
    resetQuery() {
      ...
      this.queryParams.parmas.userCode = '';
