    ...
    <el-row>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%; align: center" id="table-min">
              <tbody>
                <tr>
                  <td>修改内容</td>
                  <td>修改后</td>
                  ...
                  <td>
                    <template>
                      ...
                      <div
                        ...
                        v-if="auditFormData.auditInfoType == 6"
                      >
                        <el-image
                          style="width: 40px; height: 40px"
                          :src="dataInfo.afterValue[0]"
                          :preview-src-list="
                            dataInfo.afterValue != null
                              ? dataInfo.afterValue
                              : []
            ...
            <table cellspacing="0" style="width: 50%" id="table-min">
              <tbody>
                <tr>
                  ...
                  <td>  
                    <el-radio v-model="auditFormData.auditStatus" label="1"
                      >审核中</el-radio
                    >
                    <el-radio v-model="auditFormData.auditStatus" label="2"
                      >审核失败</el-radio
                    >
                    <el-radio v-model="auditFormData.auditStatus" label="3"
                      >审核成功</el-radio
                    >
                  </td>
                </tr>
