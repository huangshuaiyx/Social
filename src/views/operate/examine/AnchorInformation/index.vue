  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="主播长ID" prop="userId">
        <el-input v-model="queryParams.parmas.userId" placeholder="请输入内容" clearable size="small" style="width: 240px"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="主播短ID" prop="userCode">
        <el-input v-model="queryParams.parmas.userCode" placeholder="请输入内容" clearable size="small" style="width: 240px"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="auditProviderList">
      ...
      <el-table-column label="短ID" align="center" prop="userCode" />
      ...
      <el-table-column label="审核内容" align="center">
        ...
        <template slot-scope="scope">
          ...
          >
            <img :src="scope.row.afterValue" alt="" style="width: 200px" />
            <div slot="reference" class="name-wrapper">
              <img :src="scope.row.afterValue" style="width: 40px" alt="" />
            </div>
          </el-popover> -->
          <div class="demo-image__preview" v-if="scope.row.type == 2 || scope.row.type == 3">
            <el-image style="width: 40px; height: 40px" :src="scope.row.afterValue"
          ...
          <el-popover trigger="hover" placement="top" prop="afterValue" v-if="scope.row.type == 4">
            <video :src="scope.row.afterValue" width="320" height="200" controls preload></video>
            <div slot="reference" class="name-wrapper">
      ...
      <el-table-column label="代理code" align="center" prop="agentCode" />
...
export default {
  ...
  methods: {
    ...
    handleCheck(row) {
      console.log(row);
      location.href = `${window.location.origin}/#/operate/examine/auditDetail?type=2`;
    ...
    resetQuery() {
      this.queryParams.pageNum = 1;
      this.queryParams.pageSize = 10;
      this.queryParams.parmas.userType = 2;
      this.queryParams.parmas.userCode = null;
      this.queryParams.parmas.userId = null;
