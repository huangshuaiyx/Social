            ...
            getNextTask({
                ...
                if (res.code == 200) {
                    if (res.data == 0) {
                        ...
                        this.$router.replace({ path: "/operate/anchorReview/anchorRe" }); // 关闭之后要返回的页面
                    } else {
                        this.loading = false
                        this.id = res.data.id
                        this.addData = res.data
                        if (res.data.providerInfo != null) {
                            this.userIbfo = res.data.providerInfo
                            this.softData = res.data.objectiveOptions
                            this.hardData = res.data.subjectiveOptions
                            this.seriousData = res.data.seriousViolationOptions != null ? res.data.seriousViolationOptions : []
