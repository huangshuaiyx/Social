<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px"
            ...
            <el-form-item label="营销视频ID" prop="resId" label-width="150">
                <el-input @clear="clearnchange('resId')" v-model="queryParams.parmas.resId" placeholder="请输入营销视频ID" clearable size="mini" style="width: 210px" @keyup.enter.native="handleQuery" />
            </el-form-item>
            ...
            <el-form-item label="营销视频数量下限" prop="marketVideoTotalMin" label-width="150">
            ...
            <el-form-item label="营销视频数量上限" prop="marketVideoTotalMax" label-width="150">
        ...
        <el-table v-loading="loading" :data="umsInfos">
            ...
            <el-table-column label="营销视频" align="center" prop="marketVideoTotal" />
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <!-- <el-button type="primary" size="small " @click="detele(scope.row)">移除
                    </el-button> -->
                    <el-button type="primary" size="mini " @click="editInfo(scope.row)">编辑
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
import { pageTowL, getListForOperateApi, saveadd, cancelDete } from '@/api/operate/user/manager/manager'
