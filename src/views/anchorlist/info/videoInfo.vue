    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="" prop="id">
                <el-input v-model="queryParams.parmas.id" placeholder="请输入记录ID" clearable size="small" style="width: 240px" @keyup.enter.native="handleQuery" />
            </el-form-item>

            <el-form-item label="" prop="type">
                <el-select v-model="queryParams.parmas.type" placeholder="请选择类型类型" clearable size="small" style="width: 240px">
                    <el-option v-for="dict in typeOptions" :key="dict.value" :label="dict.label" :value="dict.value" />
                </el-select>
            </el-form-item>
            <el-form-item label="" prop="inviteStatus">
                <el-select v-model="queryParams.parmas.inviteStatus" placeholder="请选择发起发起状态" clearable size="small" style="width: 240px">
                    <el-option v-for="dict in typeInitiate" :key="dict.value" :label="dict.label" :value="dict.value" />
                </el-select>
            </el-form-item>
            <el-form-item label="" prop="receivedStatus">
                <el-select v-model="queryParams.parmas.receivedStatus" placeholder="请选择处理处理状态" clearable size="small" style="width: 240px">
        ...
        <pagination v-show="total > 0" :total="total" :page.sync="queryParams.pageNum" :limit.sync="queryParams.pageSize" @pagination="getVideoRecordList" />
    </div>
</template>
