...
<template>
    <div class="firstTable">
        ...
        <div class="top">
            <div class="screen">
                <el-checkbox @change="emptyvideo" v-model="markingVideo" true-label='0' false-label='1'>Show hosts with empty marking video</el-checkbox>
            </div>
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
            <el-table-column prop="userId" label="Host Id" width="220" align="center">
            </el-table-column>
            <el-table-column prop="userCode" label="Host Code" width="100" align="center"></el-table-column>
            <el-table-column prop="regionCode" label="Country" align="center"></el-table-column>
            <el-table-column prop="face" label="Avater" width="160" align="center">
            ...
            <el-table-column prop="videoFace" label="Life Video" align="center" width="160">
                <template slot-scope="scoped">
            ...
            <el-table-column prop="urls" label="Marking Video" width="160" align="center">
                <template slot-scope="scoped">
            ...
            <el-table-column prop="nickName" label="NickName" align="center" width="200"></el-table-column>
            <el-table-column prop="operationScoreLevelCode" label="Current Level Highest Level" width="200" align="center">
                <template slot-scope="scoped">
            ...
            <el-table-column prop="address" label="View" width="200" align="center">
                <template slot-scope="scoped">
                    <div class="buttons">
            ...
            <el-table-column prop="address" label="Operate" width="280px" align="center">
                <template slot-scope="scoped">
                    <div class="buttons">
...
export default {
    ...
    methods: {
        ...
        getDataList () {
            this.loading = true
            let obj = { ...this.formPage, parmas: { regionCode: this.regionCode, providerCode: this.providerId, type: '1', markingVideo: this.markingVideo, level: this.GradeInput } }
        ...
        // 操作
        removeBtn (val) {
            removerecommendApi({ type: '1', providerId: val.userId }).then(res => {
                if (res.code == 200) {
        ...
        recommed (val) {
            neverRecommendApi({ type: '1', providerId: val.userId }).then(res => {
                if (res.code == 200) {
                    this.$message.success('success！')
                    this.getDataList()
                }
