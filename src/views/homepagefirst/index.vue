        ...
        <div class="coinsfewialog">
            <div class="coinsfewInfo" @click.stop="commodityclick">
                ...
                <div class="speciesdialog">
                    ...
                    <div>
                        <img @dragstart.prevent class="species" src="../../assets/specieshomepagecoins@2x.png" alt="">
                    </div>
...
import { close, nativeEnv, JumpH5 } from "@/api/index";
...
onBeforeMount(() => {
    state.amount = getQueryString("coinsNum") ? getQueryString("coinsNum") : 0
