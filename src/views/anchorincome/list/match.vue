...
<template>
    <div class="match">
        ...
        <div v-loading="loading">
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_A" :key="index">
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_B" :key="index">
                    <div class="lable" v-show="index==0">{{  tableData.rtc_profit_match_B[0].label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
                </div>
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_C" :key="index">
                    <div class="lable" v-show="index==0">{{ item.label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_D" :key="index">
                    <div class="lable" v-show="index==0">{{ item.label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_E" :key="index">
                    <div class="lable" v-show="index==0">{{ item.label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_F" :key="index">
                    <div class="lable" v-show="index==0">{{ item.label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
            ...
            <div class="tablelist">
                <div class="benner" v-for="(item,index) in tableData.rtc_profit_match_T" :key="index">
                    <div class="lable" v-show="index==0">{{ item.label }}</div>
                    <div class="inp">
                        <el-input :disabled="imputDisabled" type='text' :maxlength="3" oninput='value=value.replace(/[^\d]/g, "").replace( /^[0] + [0 - 9] * $ / gi, "")' onafterpaste="value=value.replace(/^(0+)|[^\d]+/g,'')" @blur="onblur(item,index,'dictValue')" v-model.number="item.dictValue" size="mini"></el-input><span>COINS</span>
                    </div>
        ...
        <!-- <div v-for="(item,index) in tableData.rtc_profit_match_B" :key="index" class="tablelist">
    ...
    methods: {
        getdatalist () {
            ...
            getprivatedatalistApi(obj).then(res => {
                if (res.code == 200) {
                    if (res.data.rtc_profit_match_A.length < 6) {
                        let num = 6 - res.data.rtc_profit_match_A.length
                        let n = res.data.rtc_profit_match_A.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_A.push(obj)

                        }
                    }
                    if (res.data.rtc_profit_match_B.length < 6) {
                        let num = 6 - res.data.rtc_profit_match_B.length
                        let n = res.data.rtc_profit_match_B.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_B.push(obj)
                        }
                    }
                    if (res.data.rtc_profit_match_C.length < 6) {
                        let num = 6 - res.data.rtc_profit_match_C.length
                        let n = res.data.rtc_profit_match_C.length
                        for (let i = 0; i < num; i++) {
                            console.log(i, num);
                            let obj = {
                                cssClass: null,
                            ...
                            res.data.rtc_profit_match_C.push(obj)
                        }
                    }
                    if (res.data.rtc_profit_match_D.length < 6) {
                        let num = 6 - res.data.rtc_profit_match_D.length
                        let n = res.data.rtc_profit_match_D.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_D.push(obj)
                        }
                    }
                    if (res.data.rtc_profit_match_E.length < 6) {
                        let num = 6 - res.data.rtc_profit_match_E.length
                        let n = res.data.rtc_profit_match_E.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_E.push(obj)
                        }
                    }
                    if (res.data.rtc_profit_match_F.length < 6) {

                        let num = 6 - res.data.rtc_profit_match_F.length
                        let n = res.data.rtc_profit_match_F.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_F.push(obj)
                        }
                    }
                    if (res.data.rtc_profit_match_T.length < 6) {

                        let num = 6 - res.data.rtc_profit_match_T.length
                        let n = res.data.rtc_profit_match_T.length
                        for (let i = 0; i < num; i++) {
                            let obj = {
                                cssClass: null,
                                dictKey: "0",
                            ...
                            res.data.rtc_profit_match_T.push(obj)
                        }
                    }
                    Object.keys(res.data).forEach(item => {
                        res.data[item] = res.data[item].reverse()
                    })
                    res.data.rtc_profit_match_A[0]['label'] = '主播等级A'
                    res.data.rtc_profit_match_B[0]['label'] = '主播等级B'
                    res.data.rtc_profit_match_C[0]['label'] = '主播等级C'
                    res.data.rtc_profit_match_D[0]['label'] = '主播等级D'
                    res.data.rtc_profit_match_E[0]['label'] = '主播等级E'
                    res.data.rtc_profit_match_F[0]['label'] = '主播等级F'
                    res.data.rtc_profit_match_T[0]['label'] = '主播等级T'
        ...
        submit () {
            ...
            arr = arr.map(item => {
                ...
                return {
                    appId: '1001',
                    productId: '100201',
                    dictTypePrefix: 'rtc_profit_match',
