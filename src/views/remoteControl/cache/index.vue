<template>
    <div class="app-container">
        <el-form :inline="true" v-show="showSearch">
            ...
            <el-form-item>
                <el-button type="primary" class="but" size="mini" @click="purge()">清除缓存
                </el-button>
            </el-form-item>
        </el-form>
    ...
    methods: {
        ...
        WordPageListd() {
            if (this.userId == null || this.userId == "") {
                ...
                queryRedisCache({ redisKey: this.userId }).then((response) => {
        ...
        purge() {
            if (this.userId == null || this.userId == "") {
                ...
                delRedisCache({ redisKey: this.userId }).then(res => {
                    if (res.code == 200) {
                        this.$message({
                            type: "success",
                            message: "成功",
